...
let module = SETTING['module'];
let getreq = SETTING['file'];
const chalk = module['chalk'];
const fs = module['fs'];
const util = module['util'];
const https = module['https'];
const axios = module['axios'];
const ytsr = module['ytsr'];
const { spawn, exec, execSync } = module['child'];
const { downloadContentFromMessage, WA_DEFAULT_EPHEMERAL, getLastMessageInChat, MessageType, generateWAMessageFromContent, prepareWAMessageMedia, proto } = module['baileys'];
const moment = module['time'];
const time = moment.tz('Asia/colombo').format('DD/MM HH:mm:ss')
const speed = module['speed'];
const request = module['request'];
const path = module['path'];
const ms = module['premium'];
