...
const pino = SETTING['module']['pino'];
const chalk = SETTING['module']['chalk'];
const fs = SETTING['module']['fs'];
const jimp = SETTING['module']['jimp'];
const path = SETTING['module']['path'];
let { Boom } = SETTING['module']['boom'];
const PhoneNumber = SETTING['module']['phonenumber'];
const NodeCache = SETTING['module']['nodecache'];
const readline = SETTING['module']['readline'];
const { move } = require(SETTING['file']['move']);
const { smsg } = require(SETTING['file']['set']);
let { default: makeWASocket, useMultiFileAuthState, jidDecode, DisconnectReason, fetchLatestBaileysVersion, makeInMemoryStore, getContentType, proto, getAggregateVotesInPollMessage } = SETTING['module']['baileys'];
